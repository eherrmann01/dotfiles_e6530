...
globalkeys = my_table.join(
	...
	--Erik's custom keybindings 
	--########################################################################################################################################
    -- super + ... function keys
    awful.key({ modkey }, "F1", function () awful.util.spawn( browser1 ) end,
        {description = browser1, group = "function keys"}),
        
    awful.key({ modkey }, "F2", function () awful.util.spawn( filemanager ) end,
        {description = filemanager , group = "function keys" }),
        
    awful.key({ modkey }, "F3", function () awful.util.spawn( browser3 ) end,
        {description = "Chromium" , group = "function keys" }),
        
    awful.key({ modkey }, "F4", function () awful.util.spawn( mailclient ) end,
        {description = "Thunderbird" , group = "function keys" }),
        
    awful.key({ modkey }, "F5", function () awful.util.spawn( "darktable" ) end,
        {description = "Darktable" , group = "function keys" }),
        
    awful.key({ modkey }, "F6", function () awful.util.spawn( "gimp" ) end,
        {description = "Gimp" , group = "function keys" }),
        
    awful.key({ modkey }, "F7", function () awful.util.spawn( editorgui ) end,
        {description = "Code" , group = "function keys" }),
        
    awful.key({ modkey }, "F8", function () awful.util.spawn( "geany" ) end,
